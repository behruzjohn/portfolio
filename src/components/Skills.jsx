...
import { Code2, Database, Globe, Layout, Smartphone, Server } from 'lucide-react';
...
const skills = [
  ...
  },
  {
    ...
    items: ["Git & GitHub", "VS Code", "Vite", "SEO Optimization", "Responsive Design"]
  }
];
    ...
    <section id="skills" className="py-20 bg-slate-50 dark:bg-black/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="mt-4 text-slate-600 dark:text-slate-300">Technologies I work with to bring ideas to life.</p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {skills.map((skill, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white text-center mb-6">{skill.category}</h3>
